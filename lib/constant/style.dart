...
class Style {
  ...
  static final Color primaryColor = Colors.white; // 默认主题色
  static final MaterialColor primarySwatch = Colors.amber; //
  static const String fontFamily = '微软雅黑'; // 默认字体 ComicNeue
}
