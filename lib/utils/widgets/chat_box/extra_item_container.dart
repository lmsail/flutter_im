...
class _ExtraItemContainerState extends State<ExtraItemContainer> {
  ...
  Widget build(BuildContext context) {
    return PageView(children: createPages());
  }
      ...
      children: <Widget>[
        Expanded(
          child: Row(
            ...
            children: <Widget>[for (final item in itemList1) Expanded(child: item.buildItem())],
          ),
        ),
        Expanded(
          child: Row(
            children: <Widget>[for (final item in itemList2) Expanded(child: item.buildItem())],
          ),
        ),
      ],
    );
    ...
    return InkWell(
      ...
      child: Container(
        child: Column(
          ...
          children: <Widget>[icon, Container(height: 10), Text(text)],
        ),
      ),
    );
  }
