...
import 'package:flutter_im/utils/widgets/text_field/mh_text_field.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart' as FlutterScreenUtil;

class SearchBar extends StatefulWidget {
  SearchBar({
    Key key,
    this.contentPadding = const EdgeInsets.symmetric(horizontal: 8.0, vertical: 8.0),
    this.onEdit,
    this.onCancel,
  }) : super(key: key);
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          AnimatedPositioned(
            left: 0,
            right: _isEdit ? FlutterScreenUtil.ScreenUtil().setWidth(162.0) : 8.0,
            top: 0,
            bottom: 0,
            child: InkWell(
              onTap: _onEditTap,
          ...
          AnimatedPositioned(
            ...
            left: _isEdit ? FlutterScreenUtil.ScreenUtil().setWidth(33.0) : (_isPrepared ? _searchIconLeft : null),
            bottom: 0,
            child: InkWell(
              onTap: _onEditTap,
              highlightColor: Colors.transparent,
          ...
          AnimatedPositioned(
            top: 0,
            right: _isEdit ? 0 : -1 * FlutterScreenUtil.ScreenUtil().setWidth(162.0),
            bottom: 0,
            child: InkWell(
              onTap: _onCancelTap,
              highlightColor: Colors.transparent,
