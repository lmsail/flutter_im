              ...
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: ScaleTransition(
                    scale: new Tween(begin: _scaleBegin, end: _scaleEnd).animate(_animation),
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            _buildLine(),
            _buildMenuItemWidget(
              icon: Constant.assetsImagesContacts + 'icons_filled_add-friends.svg',
              name: '添加朋友',
              index: 1,
            ),
            _buildLine(),
            ...
            _buildLine(),
            _buildMenuItemWidget(
              icon: Constant.assetsImagesMainframe + 'icon_filled_out.svg',
              name: '退出',
              index: 4,
            ),
          ],
