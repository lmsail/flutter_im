...
class _SearchContentState extends State<SearchContent> {
  ...
  Widget build(BuildContext context) {
    ...
    double bottom = ScreenUtil().setHeight(-240);
    return InkWell(
      onTap: () {
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: BorderRadius.circular(ScreenUtil().setWidth(171.0 * 0.5)),
                      ),
                    ),
                  ),
                  Positioned(
                    ...
                    child: new SvgPicture.asset(
                      Constant.assetsImagesMainframe + 'icons_filled_voiceinput_white.svg',
  ...
  Widget _buidAppointContentItemWidget({
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: index == 2 ? null : Border(right: BorderSide(color: Color(0xFFC9C9C9))),
        ),
        child: Text(
          title,
          style: TextStyle(
